...
axios.get("https://airdna-next.cdn.prismic.io/airdna-next/c009256c-e3e1-4cc3-a9c1-a458b8f86b32_BPTI+-+Australia+For+Landing+Page+CSV.csv")
      .then((response) => {
...
<div class="styles__TableStyles-sc-1nv356l-0 FZZpa">
          ...
          {data.map((item, index) => (
             ...
             <td role="cell">{item["Rental Demand"]}</td>
             <td role="cell">{item["Revenue Growth"]}</td>
           </tr>
          ))}
